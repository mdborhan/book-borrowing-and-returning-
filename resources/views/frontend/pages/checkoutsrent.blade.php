...
@section('content')
  <div class='container margin-top-20 mb-3'>
    <div class="card card-body">
     <center>  <h2>Confirm  Rent Items</h2> </center>
      <hr>
      <div class="row">
      ...
      <center style="margin-top:20px;">
        <a href="{{ route('cartsrent') }}"><button class="btn btn-info btn-lg" style="border-radius:5px;"> Change Cart Items</button></a>
      </center>
    </div>
    <div class="card card-body mt-2 mb-4">
   <center>   <h2>Shipping Address</h2></center> 
<hr>
      <form method="POST" action="{{ route('checkoutrents.store') }}">
        @csrf
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <select class="form-control" name="payment_method_id" required id="payments">
              <option value="" selected>Select a payment method please</option>
